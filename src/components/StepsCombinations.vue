<template>
    <div class="ma-4">
        ...
        <v-data-table density="compact" :headers="items_headers" :items="items" class="elevation-1" hide-default-footer disable-pagination :loading="loading" :key="'T'+key" height="70vh">
