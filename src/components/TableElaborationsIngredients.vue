<template>
    <div>    
        <v-data-table density="compact" :headers="products_in_headers()" :items="elaboration.elaborations_products_in" sort-by="final_grams" :sort-desc="['final_grams']" class="elevation-1" hide-default-footer :items-per-page="10000" :key="'T'+key" height="50vh" fixed-header>
