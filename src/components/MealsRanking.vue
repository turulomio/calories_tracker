<template>
    <div class="ma-4">
        ...
        <v-data-table density="compact" :headers="ranking_headers" :items="ranking" sort-by="position" class="elevation-1" hide-default-footer :items-per-page="10000" :loading="loading" :key="key" fixed-header height="500">
