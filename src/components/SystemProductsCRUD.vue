    ...
    <div>    
        ...
        <v-card class="pa-6 mt-4" style="overflow-y: scroll" :height="600" >
            <v-form ref="form" v-model="form_valid" lazy-validation >
                ...
                <v-text-field :readonly="mode=='D'" v-model="new_system_product.sodium" type="number" :label="$t('Set system product sodium (mg)')" :placeholder="$t('Set system product sodium (mg)')" :rules="RulesFloat(10,false)" counter="10"/>
                <v-text-field :readonly="mode=='D'" v-model="new_system_product.potassium" type="number" :label="$t('Set system product potassium (mg)')" :placeholder="$t('Set system product potassium (mg)')" :rules="RulesFloat(10,false)" counter="10"/>
                ...
                <v-text-field :readonly="mode=='D'" v-model="new_system_product.ferrum" type="number" :label="$t('Set system product ferrum (mg)')" :placeholder="$t('Set system product ferrum (mg)')" :rules="RulesFloat(10,false)" counter="10"/>
                <v-text-field :readonly="mode=='D'" v-model="new_system_product.magnesium" type="number" :label="$t('Set system product magnesium (mg)')" :placeholder="$t('Set system product magnesium (mg)')" :rules="RulesFloat(10,false)" counter="10"/>
                <v-text-field :readonly="mode=='D'" v-model="new_system_product.phosphor" type="number" :label="$t('Set system product phosphor (mg)')" :placeholder="$t('Set system product phosphor (mg)')" :rules="RulesFloat(10,false)" counter="10"/>
                <v-text-field :readonly="mode=='D'" v-model="new_system_product.calcium" type="number" :label="$t('Set system product calcium (mg)')" :placeholder="$t('Set system product calcium (mg)')" :rules="RulesFloat(10,false)" counter="10"/>
