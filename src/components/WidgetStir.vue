<template>
    <div>
        <v-row>
            <v-autocomplete :readonly="readonly" :items="$store.state.stir_types" v-model="new_value.stir_types" :label="$t('Stir types')" item-text="localname" item-value="url" :rules="RulesSelection(false)" @change="refresh" chips></v-autocomplete>
