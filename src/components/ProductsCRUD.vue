    ...
    <div>    
        ...
        <v-card class="pa-6 mt-4" style="overflow-y: scroll" :height="600" >
            <v-form ref="form" v-model="form_valid" lazy-validation >
                ...
                <v-card class="mt-4">
                    <v-data-table density="compact" :headers="formats_headers" :items="newproduct.formats" sort-by="formats" class="elevation-1" hide-default-footer :items-per-page="10000" :key="'T'+key" :height="250">
