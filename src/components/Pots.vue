<template>
    <div class="ma-4">
        ...
        <v-data-table density="compact" :headers="pots_headers" :key="key" :items="pots" sort-by="name" class="elevation-1" hide-default-footer disable-pagination item-key="item_key" :height="500">   
