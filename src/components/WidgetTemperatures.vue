<template>
    <div>
        <v-row>
            <v-autocomplete :readonly="readonly" :items="getArrayFromMap(store().temperatures_types)" v-model="new_value.temperatures_types" :label="$t('Temperature types')" item-title="localname" item-value="url" :rules="RulesSelection(false)" @change="refresh" chips></v-autocomplete>
