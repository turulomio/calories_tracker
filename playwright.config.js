...
// Increase browser download timeout (in milliseconds)
process.env.PLAYWRIGHT_DOWNLOAD_CONNECTION_TIMEOUT = process.env.PLAYWRIGHT_DOWNLOAD_CONNECTION_TIMEOUT || '180000';
...
export default defineConfig({
  ...
  use: {
    ...
    baseURL: 'http://127.0.0.1:8012/calories_tracker/',
  ...
  webServer: {
    command: 'npm run dev',
    url: 'http://127.0.0.1:8012/calories_tracker/',
