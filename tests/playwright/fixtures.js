...
const test = baseTest.extend({
  ...
  await page.goto('http://127.0.0.1:8006/calories_tracker/');
...
//   await page.waitForURL('http://127.0.0.1:8006/calories_tracker/home/')
    
    // Wait for successful login, e.g., navigation to dashboard
    await expect(page).toHaveURL('http://127.0.0.1:8006/calories_tracker/about/');
